...
class ImageButton(tk.Frame):
    ...
    def __init__(self, master, image_path: str, **kwargs):
        ...
        utils.add_bindtag_to(bindtag_of=self, to=self.image_preview)
        ...
        utils.add_bindtag_to(bindtag_of=self, to=self.image_name_text)
    ...
    def open_menu(self, event):
        ...
        menu.config
        menu.add_command(
            label="Open File", command=lambda: utils.file_open(self.image_path)
        )
        menu.add_command(
            label="Reveal in File Explorer",
            command=lambda: utils.file_open_in_explorer(self.image_path),
        )
